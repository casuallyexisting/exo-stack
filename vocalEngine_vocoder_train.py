from vocalEngine.utils import argutils
from vocalEngine.vocoder.train import train
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--models_dir", type=str, default="vocalEngine/vocoder/saved_models/", help=\
    ...
    # Run the training
    argutils.print_args(args, parser)
    train(**vars(args))
