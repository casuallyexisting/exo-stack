from vocalEngine.synthesizer.synthesize import run_synthesis
from vocalEngine.synthesizer.hparams import hparams
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_dir", type=str,
                        default="vocalEngine/synthesizer/saved_models/logs-pretrained/", help=\
